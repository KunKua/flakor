#ifndef PLATFORM_PLATFORMMEM_H
#define PLATFORM_PLATFORMMEM_H

struct PlatformMemConstants
{
		/** The amount of actual physical memory, in bytes */
		size_t totalPhysical;
		/** The amount of virtual memory, in bytes */
		size_t totalVirtual;
		/** The size of a page, in pages */
		size_t pageSize;
		/** Approximate physical RAM in GB; 1 on everything except PC.*/
		uint32_t totalPhysicalGB
}

struct PlatformMemStats : public PlatformMemConstants
{
